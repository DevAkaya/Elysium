...
var NinjaCursorForWindow = class {
  constructor(app2, aw, ad, registerDomEvent) {
    ...
    const moveCursor = (e, noAnimate) => {
      ...
      root.style.setProperty("--cursor-drag-height", `${cursorDragHeight}px`);
      root.style.setProperty("--cursor-drag-width", `${cursorDragWidth}px`);
      root.style.setProperty("--cursor-drag-angle", `${cursorDragAngle}rad`);
